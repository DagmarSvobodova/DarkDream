...
mix.js('resources/js/welcomepage/index.jsx', 'public/js/main.js').react();
...
mix.js('resources/js/category/Spaceships.jsx', 'public/js/spaceships.js').react();
mix.js('resources/js/category/Spaceitems.jsx', 'public/js/spaceitems.js').react();
